...
const SessionEditor = () => {
  ...
  useEffect(() => {
    ...
    if (id) {
      axios.get(`/api/sessions/my-sessions/${id}`)
        .then(res => {
  ...
  const handleSaveDraft = async () => {
    ...
    try {
      ...
      const res = await axios.post('/api/sessions/my-sessions/save-draft', payload);
      if (res.data.success) {
  ...
  const handlePublish = async () => {
    ...
    try {
      ...
      if (!id) {
        const res = await axios.post('/api/sessions/my-sessions/save-draft', session);
